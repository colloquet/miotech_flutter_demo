  ...
  factory Security.fromJson(Map<String, dynamic> json) {
    ...
    return Security(
      ...
      percentChangeFromPreviousClose: security['equityAsset']
          ...
          .toDouble(),
      lastUpdateTime: int.parse(security['equityAsset']['equityTradingQuote']['lastUpdateTime']),
      previousClose: security['equityAsset']['equityTradingQuote']['previousClose'].toDouble(),
